...
如果你还不知道 geth 是什么，请先阅读[入门篇：以太坊是什么](https://learnblockchain.cn/2017/11/20/whatiseth/)。
更多 geth 实战使用方法请参考[Geth 控制台使用实战及 Web3.js 使用](https://learnblockchain.cn/2017/12/01/geth_cmd_short/)
以下开始正文。
...
原文会尽量随 geth 升级保持更新，原始链接：[https://learnblockchain.cn/2017/11/29/geth_cmd_options/](https://learnblockchain.cn/2017/11/29/geth_cmd_options)

- **本文作者：** Tiny 熊
- **本文链接：** <https://learnblockchain.cn/2017/11/29/geth_cmd_options/>
