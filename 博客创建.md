...
def add_files(files)
  ...
  files.each do |file|
    ...
    result = HTTParty.post("http://dccmm.world/api/topics/create",:query => query,:headers => headers)
...
def remove_file(files)
  ...
  files.each do |file|
    ...
    result = HTTParty.delete("http://dccmm.world/api/topics/delete",:query => query,:headers => headers)
    if result["status"] == 0
      puts "#{result}                 \033[22;32m✔\033[0m\n\n"
    else
      puts "#{result}                  \033[22;31m✗\033[0m\n\n"
